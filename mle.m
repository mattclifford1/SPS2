...
for i = 1:length(pngFilesS)
    ...
    testS = [testS; getFeature1(testImage),getFeature2(testImage)]; 
...
for i = 1:length(pngFilesT)
    ...
    testT = [testT; getFeature1(testImage),getFeature2(testImage)];
...
for i = 1:length(pngFilesV)
    ...
    testV = [testV; getFeature1(testImage),getFeature2(testImage)];
